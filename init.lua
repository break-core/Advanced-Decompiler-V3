...
--[[
	...
	Written in Luau, for Luau.
	
	The credits for this on Github are as follows:
	- w-a-e, created the original Advanced Decompiler V3 as well as this rewrite
	- break-core, modified the rewrite to work with exploits and work better with studio.
	- Reselim, creator of the buffer-based Base64 module used here for ultra-fast decoding.
]]
